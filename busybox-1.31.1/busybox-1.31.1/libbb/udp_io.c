 ...
 */
void FAST_FUNC socket_want_pktinfo(int fd UNUSED_PARAM)
{
#ifdef IP_PKTINFO
...
ssize_t FAST_FUNC send_to_from(int fd, void *buf, size_t len, int flags,
...
ssize_t FAST_FUNC recv_from_to(int fd, void *buf, size_t len, int flags,
