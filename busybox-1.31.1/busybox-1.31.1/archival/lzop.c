...
/**********************************************************************/
static FAST_FUNC uint32_t lzo_adler32(uint32_t adler, const uint8_t *buf, unsigned len)
{
    enum
    {
...
static FAST_FUNC uint32_t lzo_crc32(uint32_t c, const uint8_t *buf, unsigned len)
{
