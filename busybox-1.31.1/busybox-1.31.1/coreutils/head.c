...
#endif
static void print_first_N(FILE *fp, unsigned long count, bool count_bytes)
{
#if !ENABLE_FEATURE_FANCY_HEAD
...
#if ENABLE_FEATURE_FANCY_HEAD
static void print_except_N_last_bytes(FILE *fp, unsigned count)
{
...
static void print_except_N_last_lines(FILE *fp, unsigned count)
{
...
#endif
static unsigned long eat_num(bool *negative_N, const char *p)
{
#if ENABLE_FEATURE_FANCY_HEAD
    if (*p == '-')
    {
