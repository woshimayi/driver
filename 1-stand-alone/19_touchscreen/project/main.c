...
int main(void)
{
    ...
    while (1)
    {
        ...
        {
            ft5426_read_tpcoord();
            lcd_shownum(50 + 72, 110 ft5426_dev.point_num, 1, 24);
            lcd_shownum(50 + 72, 130 ft5426_dev.x[0], 5, 24);
            lcd_shownum(50 + 72, 150, ft5426_dev.y[0], 5, 24);
            lcd_shownum(50 + 72, 170, ft5426_dev.x[1], 5, 24);
            lcd_shownum(50 + 72, 190, ft5426_dev.y[1], 5, 24);
            lcd_shownum(50 + 72, 210, ft5426_dev.x[2], 5, 24);
            lcd_shownum(50 + 72, 230, ft5426_dev.y[2], 5, 24);
            lcd_shownum(50 + 72, 250, ft5426_dev.x[3], 5, 24);
            lcd_shownum(50 + 72, 270, ft5426_dev.y[3], 5, 24);
            lcd_shownum(50 + 72, 290, ft5426_dev.x[4], 5, 24);
            lcd_shownum(50 + 72, 310, ft5426_dev.y[4], 5, 24);
