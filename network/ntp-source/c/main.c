...
void lookup(char *host, struct sockaddr_in * host_addr)
{
    ...
    host_addr = (struct sockaddr_in *)res->ai_addr;

//    for (cur = res; cur != NULL; cur = cur->ai_next)
//    {
//        host_addr = (struct sockaddr_in *)cur->ai_addr;
//        printf("%s\n", inet_ntop(AF_INET,
//                                 &host_addr->sin_addr, ipbuf, 16));
//    }
    freeaddrinfo(res);
}
...
int main(int argc, char *argv[ ])
{
    ...
    *((char *) &packet + 0) = 0x1b;     // Represents 27 in base 10 or 00011011 in base 2.
    ...
    lookup(host_name, &serv_addr);   // Convert URL to IP.
