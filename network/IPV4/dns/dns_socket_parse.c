/*
 * @*************************************:
 * @FilePath: /network/IPV4/dns/dns_socket_parse.c
 * @version:
 * @Author: dof
 * @Date: 2022-08-02 11:44:10
 * @LastEditors: dof
 * @LastEditTime: 2023-11-03 10:50:09
...
{
	GuangDong_ParaseIpv6Domain("veip0.1", "www.tytest6.net", const char *dnsserver, char *domainIp, const char IsIpv6) return 0;
}
