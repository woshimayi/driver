/*
 * @*************************************: 
 * @FilePath: /user/C/string/bua_data (2).c
 * @version: 
 * @Author: dof
 * @Date: 2021-10-20 19:33:39
 * @LastEditors: dof
 * @LastEditTime: 2021-12-07 14:10:04
 * @Descripttion: 按照分号 解构字符串
 * @**************************************: 
 */
#include <stdio.h>
#include <stdlib.h>
...
int main()
{
    char informurl1[1024] = "http://www.bbums.cn/reg/";
    char informurl2[1024] = "http://www.bbums.org.cn/reg/";
    ...
    urlNode = create_informUrl(informurl3, urlNode);
    urlNode = amend_informUrl(informurl4, urlNode);
