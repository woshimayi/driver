/*
 * @*************************************:
 * @FilePath: /user/C/string/array_test.c
 * @version:
 * @Author: dof
 * @Date: 2023-09-15 11:14:44
 * @LastEditors: dof
 * @LastEditTime: 2023-09-15 11:52:39
 * @Descripttion: 状态机 结构体示例 hash 示例
 * @**************************************:
 */
...
int main(int argc, char const *argv[])
{
	...
	// {
	// 	printf("%s %10s\n", chipId[i].chain_name, chipId[i].table_name);
	// }
	printf("%s\n", chipId[BOB_TYPE_28L95].chain_name,  chipId[BOB_TYPE_28L95].add_chain_rules(chipId[BOB_TYPE_28L95].chain_name));
	return 0;
}
