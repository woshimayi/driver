...
const char *cmsErr_getStringBuf(CmsRet ret, char *buf, UINT32 buflen)
{
   ...
   case CMSRET_INVALID_URL_FORMAT:
      errorStr = "Bad/illegal URL format or missing URL";
      break;
   ...
   case CMSRET_FILE_TRANSFER_FILE_AUTHENTICATION_ERROR:
      errorStr = "File authentication error";
      break;
   ...
   case CMSRET_PARENTEE_EE_VERSION_MISMATCH:
      errorStr = " Platform version needed by EE is not available";
      break;
