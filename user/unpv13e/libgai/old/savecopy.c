...
static int ga_aistruct(struct addrinfo ***paipnext, const struct addrinfo *hintsp,
...
static int ga_unix(const char *path, struct addrinfo *hintsp, struct addrinfo **result)
{
    struct addrinfo		*ai;
