...
axel -n 4 https://download.qt.io/development_releases/qt/5.15/5.15.0-rc2/single/qt-everywhere-src-5.15.0-rc2.tar.xz
xz -d qt-everywhere-src-5.15.0-rc2.tar.xz
